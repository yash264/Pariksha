...
function QuizWindow() {
    ...
    useEffect(() => {
        axios.post('http://localhost:3000/particularQuizDetail', { quizInfo })
            .then(result => {
    ...
    const savedAnswers = async () => {
        const result = await axios.post('http://localhost:3000/savedAnswer', { email, quizInfo, currentQuestion, clickedOption, correctAnswer });
        showSavedAnswer();
    }

    const clearAnswers = async () => {
        const result = await axios.post('http://localhost:3000/clearAnswer', { email, quizInfo, currentQuestion, clickedOption });
        showSavedAnswer();
    }
    ...
    const showSavedAnswer = () => {
        axios.post('http://localhost:3000/result', { quizInfo, email })
            .then(result => {
    ...
    const showResultWindow = () => {
        axios.post('http://localhost:3000/confirmation', {quizInfo, email})
            .then(result => {
