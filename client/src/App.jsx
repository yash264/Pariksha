  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/User/liveQuiz" element={<LiveQuiz />}></Route>
        <Route path="/User/pastQuiz" element={<PastQuiz />}></Route>
        <Route path="/User/studyMaterial" element={<StudyMaterial />}></Route>
        <Route path="/User/quizLogin/:id" element={<QuizLogin />}></Route>
        ...
        <Route path="/User/delete" element={<Delete />}></Route>
